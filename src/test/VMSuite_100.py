...
class VMSuite(unittest.TestCase):
    ...
    def test_93(self):
        input = """[[],
        [func(isEven,[par(n,integer)],boolean,[
            assign(isEven,eql(imod(n,2),0))
        ])],
        [call(writeBool,[call(isEven,[4])]), call(writeLn,[]),
        call(writeBool,[call(isEven,[5])]), call(writeLn,[])]]."""
        expect = "true\nfalse\n"
    ...
    def test_95(self):
        input = """[[],
        [func(greet,[],string,[assign(greet,"hello")])],
        [call(writeStrLn,[call(greet,[])])]]."""
        expect = "hello\n"
        self.assertTrue(TestVM.test(input, expect, 95))

    def test_96(self):
        input = """[[],
        [func(five,[],integer,[assign(five,5)])],
        [block([var(x,boolean)],[
            assign(x,less(call(five,[]),10)),
            call(writeBool,[x]),
            call(writeLn,[])
        ])]]."""
        expect = "true\n"
    ...
    def test_97(self):
        input = """[[const(c,7)],
        [func(addC,[par(x,integer)],integer,[assign(addC,add(x,c))])],
        [call(writeIntLn,[call(addC,[3])])]]."""
        expect = "10\n"
    ...
    def test_98(self):
        ...
        expect = "Cannot assign to a constant: assign(x,true)"
        self.assertTrue(TestVM.test(input, expect, 98))

    def test_99(self):
        input = """[[],[],[
            block([const(a,1),var(b,integer)],[
                assign(b,add(a,2)),
                call(writeIntLn,[b])
            ])
        ]]."""
    ...
    def test_100(self):
        input = """[[var(a,boolean)],[],[
            assign(a,band(less(1,2),greater(5,4))),
            call(writeBool,[a]),
            call(writeLn,[])
        ]]."""
        expect = "true\n"
