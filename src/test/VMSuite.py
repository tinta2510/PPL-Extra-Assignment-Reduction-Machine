...
#         self.assertTrue(TestVM.test(input, expect, 468))
    ...
    #     expect = "true\nfalse\n"
    #     self.assertTrue(TestVM.test(input, expect, 102))
    ...
    #     ])]]."""
    #     expect = "11\n"
    #     self.assertTrue(TestVM.test(input, expect, 103))
    ...
    #     ]]."""
    #     expect = "true\n"
    #     self.assertTrue(TestVM.test(input, expect, 104))
    ...
    #     ]]."""
    #     expect = "Invalid expression: x"
    #     self.assertTrue(TestVM.test(input, expect, 105))
    ...
    #     ]]."""
    #     expect = "2.0\n"
    #     self.assertTrue(TestVM.test(input, expect, 106))
    ...
    #     ]]."""
    #     expect = "yes\n"
    #     self.assertTrue(TestVM.test(input, expect, 107))
    ...
    #     ]]."""
    #     expect = "true\n"
    #     self.assertTrue(TestVM.test(input, expect, 108))
    ...
    #     expect = "big\n"
    #     self.assertTrue(TestVM.test(input, expect, 109))
    ...
    #     ])]]."""
    #     expect = "15\n"
    #     self.assertTrue(TestVM.test(input, expect, 110))
